...
#define PITCH_SPEED_PID_KP        3000.0f//原始数值10000.0f
#define PITCH_SPEED_PID_KI        10.0f//原始数值60.0f
#define PITCH_SPEED_PID_KD        0.0f//原始数值0.0f
#define PITCH_SPEED_PID_MAX_OUT   30000.0f//原始数值30000.0f
#define PITCH_SPEED_PID_MAX_IOUT  5000.0f//原始数值10000.0f

//yaw speed close-loop PID params, max out and max iout
//yaw 速度环 PID参数以及 PID最大输出，积分输出
#define YAW_SPEED_PID_KP        8000.0f//原始值3600.0f
#define YAW_SPEED_PID_KI        20.0f//原始值20.0f
#define YAW_SPEED_PID_KD        0.0f//原始值0.0f
#define YAW_SPEED_PID_MAX_OUT   25000.0f//原始值30000.0f
#define YAW_SPEED_PID_MAX_IOUT  1000.0f//原始值5000.0f

//pitch gyro angle close-loop PID params, max out and max iout
//pitch 角度环 角度由陀螺仪解算 PID参数以及 PID最大输出，积分输出
#define PITCH_GYRO_ABSOLUTE_PID_KP 8.0f//原始数值 15.0f
#define PITCH_GYRO_ABSOLUTE_PID_KI 0.0f//原始数值0.0f
#define PITCH_GYRO_ABSOLUTE_PID_KD 0.0f//原始数值0.0f
...
#define YAW_GYRO_ABSOLUTE_PID_KP        4.0f//原始数值 26.0f
#define YAW_GYRO_ABSOLUTE_PID_KI        0.0f//原始值0.0f
#define YAW_GYRO_ABSOLUTE_PID_KD        0.05f//原始值0.3f
#define YAW_GYRO_ABSOLUTE_PID_MAX_OUT   20.0f//原始值10.0f
#define YAW_GYRO_ABSOLUTE_PID_MAX_IOUT  0.0f//原始值0.0f

//pitch encode angle close-loop PID params, max out and max iout
//pitch 角度环 角度由编码器 PID参数以及 PID最大输出，积分输出
#define PITCH_ENCODE_RELATIVE_PID_KP 15.0f//原始值15
...
#define GIMBAL_CALI_PTICH_MOTOR_SET   14000 //双枪云台需要扭矩较大
#define GIMBAL_CALI_YAW_MOTOR_SET     6000
...
typedef struct
{
    ...
    gimbal_step_cali_t gimbal_cali;
		float limit_pitch_min;
		float limt_pitch_max;
} gimbal_control_t;
